...
const OrderFilter = props => (
  <Filter {...props}>
    ...
    <NullableBooleanInput label={'Offer accepted'} source="offeraccepted" />
  </Filter>
);
...
class TabbedDatagrid extends React.Component {
  ...
  state = { requested: [], verified: [], cancelled: [] };
            ...
            {filterValues.status === "verified" && (
              <Datagrid {...props} ids={this.state.delivered}>
                ...
                <NumberField
                  ...
                  label={'Amount Requested'}
                />
                <BooleanField label={'Offer accepted'} source="offeraccepted" />
                <EditButton />
              </Datagrid>
            )}
